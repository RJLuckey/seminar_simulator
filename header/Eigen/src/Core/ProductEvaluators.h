...
#if 0
    stdev::cerr << "LhsOuterStrideBytes=  " << LhsOuterStrideBytes << "\n";
    stdev::cerr << "RhsOuterStrideBytes=  " << RhsOuterStrideBytes << "\n";
    stdev::cerr << "LhsAlignment=         " << LhsAlignment << "\n";
    stdev::cerr << "RhsAlignment=         " << RhsAlignment << "\n";
    stdev::cerr << "CanVectorizeLhs=      " << CanVectorizeLhs << "\n";
    stdev::cerr << "CanVectorizeRhs=      " << CanVectorizeRhs << "\n";
    stdev::cerr << "CanVectorizeInner=    " << CanVectorizeInner << "\n";
    stdev::cerr << "EvalToRowMajor=       " << EvalToRowMajor << "\n";
    stdev::cerr << "Alignment=            " << Alignment << "\n";
    stdev::cerr << "Flags=                " << Flags << "\n";
#endif
  }
